package  
{
	...
	public class PlayState extends FlxState
	{
		...
		private var playerdummy:PlayerDummy;
		...
		private function hitStar(p:FlxObject, star:FlxObject):void
		{
			...
			if (FlxG.score == 2)  
			{
				level.openEntrance(); //opens entrance
			}
			if (FlxG.score == 3)
			{
				level.openEntranceTwo(); //opens 2nd entrance
			}
			if (FlxG.score == 4)
			{
				level.openEntranceThree(); //opens 3rd entrance
			}
		}
