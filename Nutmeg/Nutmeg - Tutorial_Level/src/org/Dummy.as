package  
{
	...
	public class Dummy extends FlxSprite
	{
		[Embed(source="../../assets/player.png")] private var dummyPNG:Class;
		
		public var isDying:Boolean = false;
		
		public function Dummy(x:int, y:int)
		{
			super(x * 16, y * 16);
			
			loadGraphic(dummyPNG, true, true, 16, 16);
