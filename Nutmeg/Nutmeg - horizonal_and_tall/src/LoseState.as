package  
{
	...
	public class LoseState extends FlxState
	{
		...
		[Embed(source = "../assets/flower.png")] public var starPNG:Class;
		...
		override public function create():void
		{
			...
			won = new FlxText(0, 80, FlxG.width, "- GAME OVER -");
			won.scale.x = 4;
			won.scale.y = 4;
			...
			instruct = new FlxText(0, 120, FlxG.width, "Press Any Key to Retry");
			instruct.scale.x = 2;
			instruct.scale.y = 2;
			instruct.alignment = "center";
			instruct.shadow = 0xff000000;
			instruct.scrollFactor.x = 0;
			instruct.scrollFactor.y = 0;
